...
/// A `MempoolTransactionResponse` contains an estimate of a mempool transaction. It may not be
/// possible to know the full impact of a transaction in the mempool (ex: fee paid).
