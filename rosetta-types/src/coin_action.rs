...
/// created, it is `coin_created`. When a Coin is spent, it is `coin_spent`. It is assumed that a
/// single Coin cannot be created or spent more than once. `CoinActions` are different state changes
