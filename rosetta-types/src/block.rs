...
impl Block {
    /// Blocks contain an array of Transactions that occurred at a particular `BlockIdentifier`.  A
    ...
    pub const fn new(
        ...
        Self { block_identifier, parent_block_identifier, timestamp, transactions, metadata: None }
    }
}
