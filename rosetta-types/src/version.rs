...
impl Version {
    /// The Version object is utilized to inform the client of the versions of different components
    /// of the Rosetta implementation.
    #[must_use]
    pub const fn new(rosetta_version: String, node_version: String) -> Self {
        Self { rosetta_version, node_version, middleware_version: None, metadata: None }
    }
}
