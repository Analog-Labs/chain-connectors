...
/// `PublicKey` : `PublicKey` contains a public key byte array for a particular `CurveType` encoded
/// in hex.  Note that there is no `PrivateKey` struct as this is NEVER the concern of an
/// implementation.
