...
docker build target/release/bitcoin -f chains/bitcoin/Dockerfile -t analoglabs/connector-bitcoin:latest
...
docker build target/release/ethereum -f chains/ethereum/Dockerfile -t analoglabs/connector-ethereum:latest
...
docker build target/release/polkadot -f chains/polkadot/Dockerfile -t analoglabs/connector-polkadot:latest
...
docker build target/release/astar -f chains/astar/Dockerfile -t analoglabs/connector-astar:latest
