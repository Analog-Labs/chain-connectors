...
use rosetta_config_astar::{AstarMetadata, AstarMetadataParams};
...
#[derive(Default)]
pub struct AstarTransactionBuilder;

impl TransactionBuilder for AstarTransactionBuilder {
