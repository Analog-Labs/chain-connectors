...
mod tests {
    ...
    use rosetta_ethereum_types::{Address, BlockIdentifier, H256, U256};
    ...
    fn at_block_json_encode_works() {
        let tests = [
            ...
            ("\"0xdeadbeef\"", BlockIdentifier::Number(0xdead_beef).into()),
            ("\"0xffffffffffffffff\"", BlockIdentifier::Number(0xffff_ffff_ffff_ffff).into()),
        ];
    ...
    fn can_encode_decode_eip1186_proof() {
        ...
        let expected = EIP1186ProofResponse {
            ...
            account_proof: [
                ...
                hex!("f8669d3802a763f7db875346d03fbf86f137de55814b191c069e721f47474733b846f8440101a0b1d979de742f9e49f16bc95d78216cba45ceb23eb94185d14552879ec1393568a0b44fb4e949d0f78f87f79ee46428f23a2a5713ce6fc6e0beb3dda78c2ac1ea55").to_vec().into(),
            ].to_vec(),
            storage_proof: vec![
                StorageProof {
                    ...
                    proof: [
                        ...
                        hex!("f85180808080a09548469fab745c696f461425294816340edcd44fa9cf1d84c201342aa5b590c6a0e64144f645b0cd8966f9869bec53d27e74845b93d1226b617c4df287509074178080808080808080808080").to_vec().into(),
                        hex!("e79d33878a1bf90b4a94e2dfcf7e46345d6c3f209bf31504ec1f349be19d2f8887016bcc431cc060").to_vec().into(),
                    ].to_vec(),
                },
                StorageProof {
                    ...
                    proof: [
                        ...
                        hex!("e49e2063df22a0e142a321099692a25f57671635492324bb2fdb852cbb7224528483559704").to_vec().into(),
                    ].to_vec(),
                }
            ],
        };
