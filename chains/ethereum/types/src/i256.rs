...
impl From<FromDecStrErr> for ParseI256Error {
    fn from(err: FromDecStrErr) -> Self {
        match err {
            FromDecStrErr::InvalidCharacter => Self::InvalidDigit,
            FromDecStrErr::InvalidLength => Self::IntegerOverflow,
        }
    }
}
...
impl I256 {
    ...
    pub const MIN: Self = Self(U256([0, 0, 0, i64::MIN as u64]));
    ...
    /// # Errors
    /// Returns `Err` if the string is not a valid decimal or overflow.
    ...
    /// # Errors
    /// Returns `Err` if the string is not a valid hexadecimal or overflow.
...
impl<T: Into<Self>> ops::Add<T> for I256 {
    type Output = Self;
...
impl<T: Into<Self>> ops::AddAssign<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> ops::Sub<T> for I256 {
    type Output = Self;
...
impl<T: Into<Self>> ops::SubAssign<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> ops::Mul<T> for I256 {
    type Output = Self;
...
impl<T: Into<Self>> ops::MulAssign<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> ops::Div<T> for I256 {
    type Output = Self;
...
impl<T: Into<Self>> ops::DivAssign<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> ops::Rem<T> for I256 {
    type Output = Self;
...
impl<T: Into<Self>> ops::RemAssign<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> iter::Sum<T> for I256 {
    #[track_caller]
...
impl<T: Into<Self>> iter::Product<T> for I256 {
    #[track_caller]
