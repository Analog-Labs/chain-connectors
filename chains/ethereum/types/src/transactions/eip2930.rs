...
pub(crate) mod tests {
    ...
    pub fn build_eip2930() -> (Eip2930Transaction, Signature, serde_json::Value) {
    ...
    fn serde_encode_works() {
        let (tx, _, expected) = build_eip2930();
    ...
    fn rlp_decode_signed_works() {
        ...
        let (expected_tx, expected_sig, _) = build_eip2930();
